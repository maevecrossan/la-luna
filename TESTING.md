...
| ![testing screenshot](docs/testing/not_crawlable.png) | Links not crawlable (lighthouse test) and affecting SEO score. | ![testing screenshot](docs/testing/not_crawlable_fix.png) Repalce href links with '#'. |
